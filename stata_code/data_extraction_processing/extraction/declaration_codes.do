...
#delimit;
clear;
odbc load,  exec("select * from das.das_allocation_rules@GARFO_NEFSC where fishing_year between 2004 and 2005;") $oracle_cxn;  
...
/*AMS -- 2007 to Present */
clear;
odbc load,  exec("select * from ams.das_activity_codes@GARFO_NEFSC;") $oracle_cxn;  
